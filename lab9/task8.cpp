...
int main() {
    ...
    cout << List.searchList(head, 30) << endl;  // Expected: 1 (true)
    cout << List.searchList(head, 10) << endl;  // Expected: 1 (true)
    cout << List.searchList(head, 50) << endl;  // Expected: 1 (true)
    cout << List.searchList(head, 99) << endl;  // Expected: 0 (false)
    return 0;
}
